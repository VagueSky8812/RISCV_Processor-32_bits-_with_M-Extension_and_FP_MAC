...
HD_PWD='/home/anupam/SUMBE_Multiplier_32bit/SUMBE_Multiplier_32bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SUMBE_Multiplier_32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SUMBE_Multiplier_32.tcl
